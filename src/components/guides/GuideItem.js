...
const GuideItem = ({ guideData, className }) => {
  ...
  return (
    <div
      className="bg-[#222] rounded-[10px] overflow-hidden hover-item cursor-pointer myguide-item"
      onClick={() => {
      ...
      <div className="text-[#fff] p-[20px] guidecontent">
        <div className="">
          <div className="flex items-center mb-4">
            <h3 className="text-[16px] font-[600] ">{guideData?.name}</h3>
            ...
            <span className="text-[14px] font-[600] mr-[5px]">
              {" "}
              {guideData?.ratingAverage}
            </span>
            <span className="text-[14px] text-[#aaa]">
              ({guideData?.ratingsQuantity})
            </span>
          </div>
          <div>
