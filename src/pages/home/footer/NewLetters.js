...
const NewLetters = () => {
    return (
        <div className="py-[10px] px-0">
            ...
            <form action="">
                <input type="email" name="" placeholder="enter your email" className='w-full rounded-[50px] border-[2px] border-solid border-[#ffbc4b] bg-none text-[15px] transform-none text-[#aaa] mb-[10px] py-[12px] px-[14px]' id=""></input>
